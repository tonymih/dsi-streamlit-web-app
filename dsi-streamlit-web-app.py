...
# value is the default value that populates the cell when nothing is specified, if it is not 
# specified it defaults to the minimum value, if there is no min value, it defaults to 0
...
# the [0] and [1] mean that just the numeric part of the prediction will be extracted
